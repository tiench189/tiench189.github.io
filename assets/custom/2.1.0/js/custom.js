(function ($) {
    ...
    function progressbarConfig(data) {
        return {
            ...
            strokeWidth: (typeof data.progressbarStrokewidth !== "undefined") ? parseInt(data.progressbarStrokewidth, 10) : 4,
            ...
            duration: (typeof data.progressbarDuration !== "undefined") ? parseInt(data.progressbarDuration, 10) : 1400,
            text: {
